 ...
 */
public class OpenChallangeListRows {
    ...
    public OpenChallangeListRows() {
    }

    public OpenChallangeListRows(String challange_coins, String challange_created_by, String challange_created_date, String challange_created_for, String challange_points, String challange_subject, String challange_time) {
